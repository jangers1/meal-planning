...
import { IconButton, Box, Modal, ModalDialog, DialogTitle, DialogContent, DialogActions, Button } from '@mui/joy';
...
export function DeletableItem({ children, onDelete, confirmMessage = "Are you sure you want to delete this item?" }: DeletableItemProps) {
